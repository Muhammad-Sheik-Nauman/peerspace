...
import { Home, MessageSquare, Clock, Info, Settings, Menu, X } from 'lucide-react';
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2 bg-[#111] rounded-lg border border-gray-800"
      >
        <Menu className="h-5 w-5 text-yellow-400" />
      </button>

      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-64 bg-[#111] border-r border-gray-800 h-screen flex-col">
        {/* Logo */}
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          {/* Slide-over panel */}
          <aside className="relative w-64 bg-[#111] border-r border-gray-800 h-screen flex flex-col">
            {/* Logo & Close */}
